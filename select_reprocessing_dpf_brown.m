function status = select_reprocessing_dpf_brown(LUXcode_path, data_path_evt, data_path_rq, data_processing_xml_path, iq_xml_path)
tic
%Inputs:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if exist ('chop_filename_cvt' , 'var')  %now something to clean up the intermediary files.

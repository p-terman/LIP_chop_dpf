function [output,status] = Urlread_With_Timeout(urlChar,method,params)
% Urlread_With_Timeout is a modification to URLREAD (below) to allow for a
% setting of the java time out.
% Created 6/17/09 - php
%
...
[urlConnection,errorid,errormsg] = Urlreadwrite_With_Timeout(mfilename,urlChar);
...
urlConnection.setReadTimeout(7500); % timeout in 5 seconds

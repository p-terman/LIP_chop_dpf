...
% 
% Outputs:
%              pmt_pos: 122x3 matrix of PMT centers in cm (LUXSim standard coordinates)
%  sextant_arrangement: 122 vector to map to PMT sextant numbers
% 
% DCM 2010-03-10

...
if isempty(data_path)
	if flag_gsk10_cluster
		data_path = ['/disk/paRAID02/data/ParticleAstro/LUX01/Run010/' filename_prefix '/']; % currently looks for Run009 by default, should search as LUXLoadSettings searches
 	else

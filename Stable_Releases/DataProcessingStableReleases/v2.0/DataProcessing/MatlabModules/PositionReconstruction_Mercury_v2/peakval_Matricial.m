function [pulse_dir pulse_ref TotalEnergy] = peakval_Matricial(p_min, data, SD,pulse_area_eq, cutEv, lrfmat)
cutEv = cutEv';
...
pulse_dir = the_Direct_Component';
pulse_ref = the_Reflected_Component';
